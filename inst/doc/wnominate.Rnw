...
functions to analyze the results. The vignette presented here is a (slightly) modified version of Poole et al (2011).
...
\bibitem{Bootstrap} Poole, Keith and Jeffrey B. Lewis,(2004)
``Measuring Bias and Uncertainty in Ideal Point Estimates via the Parametric Bootstrap.''
\emph{Political Analysis} 12(2): 105-127.

\bibitem{spatial} Poole, Keith (2005)
\emph{Spatial Models of Parliamentary Voting.}
Cambridge: Cambridge University Press.

\bibitem{JSS} Poole, Keith, Jeffrey Lewis, James Lo, and Royce Carroll (2011)``Scaling Roll Call Votes with WNOMINATE in R.'' \emph{Journal of Statistical Software} 42(14): 1-2.1

\bibitem{Congress} Poole, Keith and Howard Rosenthal (1997)
\emph{Congress: A Political-Economic History of Roll Call Voting.} New York: Oxford University Press.
